...
#SBATCH --output=./slurm_out/run_synleth_5_original_seed1238.txt
#SBATCH --error=./slurm_out/run_synleth_5_original_seed1238.txt
...
do
	echo $i
	python script/run.py -s $i -c  config/knowledge_graph/synleth/synleth_trans_5layers_original.yaml --gpus [0]
done
