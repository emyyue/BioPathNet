...
python script/predict.py -c config/knowledge_graph/mock/mockdata_pred.yaml --gpus[0] --checkpoint dir/to/checkpoint/model_epoch_8.pth
...
## for graph
python script/visualize_graph.py -c config/knowledge_graph/mock/mockdata_pred.yaml --gpus [0] --checkpoint dir/to/checkpoint/model_epoch_8.pth

## for detail to each path
python script/visualize.py -c config/knowledge_graph/mock/mockdata_pred.yaml --gpus [0] --checkpoint dir/to/checkpoint/model_epoch_8.pth
