...
#SBATCH --output=./slurm_out/vis_cp_woLeak-%j.txt
#SBATCH --error=./slurm_out/vis_cp_woLeak-%j.txt
#SBATCH --time=4:00:00
#SBATCH --mem=64Gb
#SBATCH -c 4
#SBATCH --gres=gpu:1
...
python script/visualize_graph.py -c  config/knowledge_graph/primekg/vis/cell_proliferation_vis_woLeak.yaml --gpus [0] --checkpoint /home/icb/yue.hu/proj_genefun/NBFNet/experiments/KnowledgeGraphCompletionBiomed/biomedical/NBFNet/2023-11-28-14-41-12-818389/model_epoch_9.pth
